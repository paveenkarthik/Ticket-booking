...
public class SEAT extends App {
    public static void vip(int ui, int gi, int mi) {
        while (true) {
            ...
            String q1 = "select c_vip from ticketcost1 where  ground_id=" + gi + "";
            String q2 = "select vip from seatpanel where  ground_id=" + gi + "";
            String q3 = "select vip from seat where  ground_id=" + gi + "  and match_id= " + mi + "";
            int cost = 0;
            int ps = 0;
            int ts = 0;
            int total = 0;
            ...
            try {
                ...
                String que = "update ticketcost set c_vip=" + cost + " where ground_id=" + gi + " AND match_id="+mi+"";
    ...
    public static void fcseat(int ui, int gi, int mi) {
        while (true) {
            ...
            String query = "update seat set firstclass=firstclass-" + seat + " where ground_id=" + gi
                    + " and match_id= " + mi + "";
            // String query1 = "update ground set total_seat_cap=total_seat_cap-" + seat + " where ground_id=" + gi + "";
            String q1 = "select c_fc from ticketcost1 where  ground_id=" + gi + "";
            String q2 = "select firstclass from seatpanel where  ground_id=" + gi + "";
            String q3 = "select firstclass from seat where  ground_id=" + gi + "  and match_id= " + mi + "";
            String q = "insert into ticket(user_id,ground_id,no_of_ticket,seat,amount,cur_date) values(?,?,?,?,?,?)";
            int total = 0;
            try {
                ...
                String que = "update ticketcost set c_fc=" + cost + " where ground_id=" + gi + " AND match_id="+mi+"";
                Statement stch = con.createStatement();
                stch.executeUpdate(que);
            } catch (Exception e) {
                // TODO: handle exception
    ...
    public static void scseat(int ui, int gi, int mi) {
        while (true) {
            ...
            // String query1 = "update ground set total_seat_cap=total_seat_cap-" + seat + " where ground_id=" + gi + "";
            String q = "insert into ticket(user_id,ground_id,no_of_ticket,seat,amount,cur_date) values(?,?,?,?,?,?)";
            String q1 = "select c_sc from ticketcost1 where  ground_id=" + gi + "";
            String q2 = "select secondclass from seatpanel where  ground_id=" + gi + "";
            String q3 = "select secondclass from seat where  ground_id=" + gi + "  and match_id= " + mi + "";
            int cost = 0;
            int ps = 0;
            int ts = 0;
            int total = 0;
            ...
            try {
                ...
                String que = "update ticketcost set c_sc=" + cost + " where ground_id=" + gi + " AND match_id="+mi+"";
                Statement stch = con.createStatement();
                stch.executeUpdate(que);
    ...
    public static void stseat(int ui, int gi, int mi) {
        while (true) {
            ...
            // String query1 = "update ground set total_seat_cap=total_seat_cap-" + seat + " where ground_id=" + gi + "";
            String q = "insert into ticket(user_id,ground_id,no_of_ticket,seat,amount,cur_date) values(?,?,?,?,?,?)";
            String q1 = "select c_st from ticketcost1 where  ground_id=" + gi + "";
            String q2 = "select standard from seatpanel where  ground_id=" + gi + "";
            String q3 = "select standard from seat where  ground_id=" + gi + "  and match_id= " + mi + "";
            int cost = 0;
            int ps = 0;
            int ts = 0;
            int total = 0;
            ...
            try {
                ...
                if (what == 1 && d != 0  && d2 != 0) {
                    ...
                    break;
                String que = "update ticketcost set c_st=" + cost + " where ground_id=" + gi + " AND match_id="+mi+"";
                Statement stch = con.createStatement();
                stch.executeUpdate(que);
            } catch (Exception e) {
                // TODO: handle exception
